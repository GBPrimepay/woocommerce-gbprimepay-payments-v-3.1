    ...
    class AS_Gbprimepay_ACCOUNT extends WC_Settings_Page {
      ...
      public function notice_message($message) {
        ...
        if($account_settings['environment']=='prelive'){
          ...
          switch ($message) {
            case 0:
              echo "<div class='gbp_notice_message onlyloaded success notice notice-success is-dismissible' style='display:none;padding: 12px 12px;'><p><strong>Verified, GBPrimePay Payments Settings is already set in $echopaymode</strong></p></div>";
            break;
            case 2:
            break;
            case 3:
              echo "<div class='gbp_notice_message onlyloaded error notice notice-error is-dismissible' style='display:none;padding: 12px 12px;'><p><strong>Error!, Missing credentials in config in $echopaymode</strong></p></div>";
            break;
            default:
            break;
        }
      ...
      public function gbprimepay_top() {
        ...
        $logo = plugins_url( '../assets/images/gbprimepay-logo.png', __FILE__ );

        echo "<img style='margin:15px 0px 0px -12px !important;' src='$logo' alt='gbprimepay.com'>
      ...
      public function gbprimepay_load_start() {
        echo "<script type='text/javascript'>jQuery('.gbp_notice_message').hide();</script>";
      }

      public function gbprimepay_load_end() {
        echo "<script type='text/javascript'>setTimeout(function(){jQuery('.gbp_notice_message').show();}, 700);</script>";
      }
      ...
      public function availablemethods() {
        ...
        echo "
          <div class='wrap'>
            <hr><h3>Payment Methods ($echopaymode)</h3>
              ...
              <tbody>
                <tr>
                  <td class='name' style='padding-left: 30px;'>
                    <span id='span-for-active-button'>$ccintegration</span>
                  </td>
                  <td class='status' style='text-align: center;'>
                    $echoenabledpayment
                  </td>
                  <td class='setting' style='text-align: center;'>
